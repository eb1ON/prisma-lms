...
export default async function RoadmapPage() {
  ...
  const courses = [
    { school_year: "1", name: "1-р курс", color: "bg-[#6be4b9]" },
    { school_year: "2", name: "2-р курс", color: "bg-[#6be4b9]" },
    { school_year: "3", name: "3-р курс", color: "bg-[#6be4b9]" },
    { school_year: "4", name: "4-р курс", color: "bg-[#6be4b9]" },
    { school_year: "5", name: "5-р курс", color: "bg-[#6be4b9]" },
  ];
        ...
        <div className="min-w-[1100px] relative px-8 pb-20 h-[300px]">
          ...
          <div className="relative flex justify-between items-end z-10 h-full pt-16">
            {courses.map((course, index) => (
              ...
              >
                <p className="text-sm font-medium text-gray-300 mb-2">{course.name}</p>
                <Link
                  ...
                  className={`w-16 h-16 rounded-full ${course.color} flex items-center justify-center
                    ...
                    hover:scale-110 hover:shadow-2xl hover:shadow-[#6be4b9] transition duration-300 ease-in-out`}
                >
                  {course.school_year}
                </Link>
              </div>
