...
const AdminHomePage = async () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0f181e] text-[#d6faff] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-[#13272e] border border-[#1e3a44] rounded-2xl shadow-xl px-8 py-10 space-y-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Link href="/admin/roadmap">
            <div className="bg-purple-500 text-white py-5 px-4 rounded-lg shadow-md hover:bg-purple-600 cursor-pointer transition-all text-center min-w-[160px]">
              <h2 className="text-base font-semibold mb-1">
                Сургалтын агуулга
              </h2>
            </div>
